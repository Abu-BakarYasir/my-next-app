...
import StartProjectModal from './StartProjectModal'; // make sure path is correct
    ...
    <div className="px-4 sm:px-8 md:px-16 py-6 lg:py-12 flex flex-col lg:flex-row items-center justify-center gap-[48px] font-[Inter,sans-serif] max-w-[1200px] mx-auto">
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left">
        <h1 className="mb-6 lg:mb-8 leading-[71px]">
          <span className="text-2xl sm:text-3xl md:text-4xl lg:text-[45px] font-light text-black">Great{' '}</span>
          <span className="text-3xl sm:text-4xl md:text-5xl lg:text-[45px] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#161490] via-[#7476ED] to-[#E56F8C]">Products{' '}</span>
          <span className="text-2xl sm:text-3xl md:text-4xl lg:text-[45px] font-light text-black">are{' '}</span>

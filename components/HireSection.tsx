  ...
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 py-8 sm:py-12 lg:py-16">
      <div className="bg-blue-50 rounded-lg p-4 sm:p-6 lg:p-8 flex flex-col sm:flex-row items-center justify-between max-w-4xl mx-auto shadow-md gap-4 sm:gap-6">
        ...
        <button className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full hover:from-orange-600 hover:to-red-600 transition duration-300 text-sm sm:text-base font-medium whitespace-nowrap">
          Start Your Project
        </button>
      </div>
    </div>
